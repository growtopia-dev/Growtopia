...
const Home = () => {
  ...
  // Preload the hero image so it's in the browser cache on re-visits
  // and starts fetching as early as possible on first load.
  useEffect(() => {
    const img = new Image();
    img.src = "/img2.webp";
  }, []);
    ...
    <div className="gh-container">
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Hero
           KEY FIX: background-color matches the dark overlay so while the
           image is still loading the section looks identical — no white flash. */
        .gh-editorial-hero {
